...
const UpdateProduct = () => {
  ...
  const handleUpdateProduct = (e) => {
    ...
    const updateProduct = { name, price, quantity, details, photo };
  ...
  return (
    ...
    //       <h1 className="text-3xl text-green-500 font-bold">Update Product</h1>
    //     </div>
    //     <div className="card bg-base-100 w-[550px] max-w-5xl shrink-0 shadow-2xl">
    //       <form onSubmit={handleUpdateProduct} className="card-body h-[650px]">
